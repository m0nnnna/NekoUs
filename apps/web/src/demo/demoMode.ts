 ...
 * checking a layout change, or showing someone what NekoUs is — without first deploying Synapse,
...
export const DEMO_SERVER_NAME = 'demo.nekous';
...
export const DEMO_BOT_USER_ID = `@nekous-voice-bot:${DEMO_SERVER_NAME}`;

/** Origin of the demo's fake token server. Never contacted — demoTokenServer.ts answers for it. */
export const DEMO_TOKEN_ORIGIN = 'https://token.demo.nekous';

export const DEMO_TOKEN_ENDPOINT = `${DEMO_TOKEN_ORIGIN}/api/livekit/token`;

export const DEMO_LIVEKIT_URL = 'wss://livekit.demo.nekous';
